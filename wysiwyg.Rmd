...
| [Workshop Markdown Prep](https://passerium.netlify.app/ipynb.html) | preparatory checks demonstrating quick use of Markdown in Jupyter Notebook shared with attendees from [USGS Data Carpentry workshop, Python, Shell & Git](https://jjyh.github.io/2021-10-26-usgs-online/) as instructor (scheduled)|Markdown|
| [Glycol Gliders](https://passerium.netlify.app/ipynb.html) | flowcharting excerpt from data plan documentation and "mental maps" reference print-outs for operator training, as instructor and project lead |R|
